...
var ModalSlideIn = (function (_super) {
    ...
    ModalSlideIn.prototype.init = function () {
        ...
        var /** @type {?} */ backdrop = new Animation(this.plt, backdropEle);
        var /** @type {?} */ wrapper = new Animation(this.plt, ele.querySelector('.modal-wrapper'));
...
var ModalSlideOut = (function (_super) {
    ...
    ModalSlideOut.prototype.init = function () {
        ...
        var /** @type {?} */ wrapper = new Animation(this.plt, wrapperEle);
