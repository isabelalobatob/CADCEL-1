...
var AotCompiler = (function () {
    function AotCompiler(context, options) {
        ...
        this.fileSystem = hybrid_file_system_factory_1.getInstance(false);
        this.compilerHost = compiler_host_factory_1.getInMemoryCompilerHostInstance(this.tsConfig.parsed.options);
