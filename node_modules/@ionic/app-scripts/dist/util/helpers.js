...
function isSrcOrIonicOrIonicDeps(filePath) {
...
exports.isSrcOrIonicOrIonicDeps = isSrcOrIonicOrIonicDeps;
function isIonicOrAngular(filePath) {
    return (filePath.startsWith(getStringPropertyValue(Constants.ENV_VAR_AT_ANGULAR_DIR))
        || filePath.startsWith(getStringPropertyValue(Constants.ENV_VAR_IONIC_ANGULAR_DIR)));
}
exports.isIonicOrAngular = isIonicOrAngular;
function isIonic(filePath) {
