...
describe('config', function () {
    describe('config.generateContext', function () {
        ...
        it('should set the correct defaults for a dev build', function () {
            ...
            expect(fakeConfig[Constants.ENV_VAR_AT_ANGULAR_DIR]).toEqual(path_1.join(process.cwd(), Constants.NODE_MODULES, Constants.AT_ANGULAR));
            ...
            expect(fakeConfig[Constants.ENV_OPTIMIZATION_LOADER]).toEqual(path_1.join(fakeConfig[Constants.ENV_VAR_APP_SCRIPTS_DIR], 'dist', 'webpack', 'optimization-loader.js'));
