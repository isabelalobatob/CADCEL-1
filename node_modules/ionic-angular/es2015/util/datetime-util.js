...
export function compareDates(d1, d2) {
    const /** @type {?} */ date1 = new Date(d1.year, d1.month, d1.day, d1.hour, d1.minute, d1.second);
    const /** @type {?} */ date2 = new Date(d2.year, d2.month, d2.day, d2.hour, d2.minute, d2.second);
