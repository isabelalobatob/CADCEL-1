...
function generateContext(context) {
    ...
    var angularDir = path_1.resolve(getConfigValue(context, '--angularDir', null, Constants.ENV_VAR_AT_ANGULAR_DIR, Constants.ENV_VAR_AT_ANGULAR_DIR.toLowerCase(), path_1.join(context.nodeModulesDir, Constants.AT_ANGULAR)));
    ...
    var webpackTranspileLoaderPath = path_1.join(getProcessEnvVar(Constants.ENV_VAR_APP_SCRIPTS_DIR), 'dist', 'webpack', 'transpile-loader.js');
    setProcessEnvVar(Constants.ENV_WEBPACK_TRANSPILE_LOADER, webpackTranspileLoaderPath);
    logger_1.Logger.debug("webpackTranspileLoaderPath set to " + webpackTranspileLoaderPath);
    var optimizationLoaderPath = path_1.join(getProcessEnvVar(Constants.ENV_VAR_APP_SCRIPTS_DIR), 'dist', 'webpack', 'optimization-loader.js');
    setProcessEnvVar(Constants.ENV_OPTIMIZATION_LOADER, optimizationLoaderPath);
    logger_1.Logger.debug("optimizationLoaderPath set to " + optimizationLoaderPath);
    ...
    var buildToEs5 = getConfigValue(context, '--buildToEs5', null, Constants.ENV_BUILD_TO_ES5, Constants.ENV_BUILD_TO_ES5.toLowerCase(), 'true');
    setProcessEnvVar(Constants.ENV_BUILD_TO_ES5, buildToEs5);
    logger_1.Logger.debug("buildToEs5 set to " + buildToEs5);
